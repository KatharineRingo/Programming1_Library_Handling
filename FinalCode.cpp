...
class BookDatabase {
private:
    // This vector stores every book in the database.
    vector<Book> books;
...
public:
    ...
    void displayBooks() const {
        ...
        // If not empty cycles through every element in the vector ‘books’.
...
int main() {
    ...
    do {
        ...
        switch (choice) {
            ...
            case 5: { 
	    // These are where our pointers are located.
                char* title = new char[100];
                char* author = new char[100];
                char* genre = new char[100];
                int year;

	    // User input and then calling addBook function.
